...
<div class="content" style="padding:2%">
    ...
    @endif
    <div>
        <a href="{{route('adminusers.create')}}" class="btn btn-primary">Add new Account </a>
    </div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('adminusers.edit', $users->id)}}" class="btn btn-primary" >edit</a>
                    <form action="{{ route('adminusers.destroy', $users->id) }}" method="POST"
