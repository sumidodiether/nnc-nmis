    ...
    <div class="row-12">
        <div class="col flex">
            <div class="card">
                ...
                <form method="post" class="employee-form" action="{{ route('mellpi_pro.store') }}"
                ...
                <div class="card-body">
                    <div class="nav nav-fill my-3">
                        ...
                        <label class="nav-link shadow-sm step2 border ml-2 ">Vision Mission, Nutrition Policies, Governance, LNC Management</label>
                            ...
                            <div class="row">
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="land_use_classification" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="households_sanitary_toilet" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="public_elem_secondary_schools" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="retails_outlets_stores" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="markets_transport_terminal" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>Adoption, implementation and monitoring of national/ sectoral nutrition policies</p>
                                    <p>Executive Order 51: National Code of Marketing Breastmilk Substitutes, Breastmilk Supplements and Other Related Products</p>    
                                </div>
                                <div class="col-sm">
                            ...
                            <div class="row">
                                ...
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    ...
                                    <p>DILG Memorandum Circular 2011-54 Implementation and Monitoring of the National Breastfeeding Policy</p>    
                                </div>
                                <div class="col-sm">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>NNC Governing Board Resolution No.1 series of 2017: Approving and Adopting the Philippine Plan of Action for Nutrition 2017-2022</p>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>NNC Governing Board Resolutions Nos. 1. 3 S.2012: Approving the Guidelines on the Fabrication, Verification, and Maintenance of Wooden Height Boards 2. 3 S.2018: Approving the Guidelines on the Selection of Non-Wood Height and Length Measuring Tool</p>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>NNC Governing Board Resolution No.2 S.2012: Approving the Revised Implementing Guidelines on OPT Plus</p> 
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>NNC Governing Board Resolution No. 6 series of 2012: Adoption of the 2012 Nutritional Guidelines for Filipinos</p> 
                            ...
                            <div class="row">
                                <div class="col-sm">
                                <!-- <label><b>{{__("1c")}}</b></label>  -->
                                    <p>NNC Governing Board Resolution No. 2 series of 2009: Adopting the National Policy on Nutrition Management in Emergencies and Disasters</p> 
                        ...
                        <div class="form-section">
                            ...
                            <table class="table table-striped">
                              ...
                              <tr>
                                  ...
                                  <input type="hidden" id="young_child_feeding_average2" name="young_child_feeding_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                              </tr>
                                <tr>
                                  ...
                                  <td>
                                        <select class="form-control rating1" name="young_child_feeding_rating1" id="breastfeeding_rating">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                            <option value="4">4</option>
                                  ...
                                  <td><textarea name="young_child_feeding_remarks1" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>

                                <tr>
                                  <td scope="row">2. Lactation stations established in barangay facilities such as Barangay Health Stations, multi-purpose hall and in public schools</td>
                                  <td>
                                  ...
                                  <td><textarea name="young_child_feeding_remarks2" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>

                                <tr>
                                  <td scope="row">3. Activities conducted to promote compliance to Executive Order 51, Milk Code</td>
                                  <td>
                                  ...
                                  <td><textarea name="young_child_feeding_remarks3" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>

                                <tr>
                                  <th scope="row">{{__("Philippine Integrated Management of Acute Malnutrition")}}</th>
                                  <th id="acute_malnutrition_average">0</th>
                                  <input type="hidden" id="acute_malnutrition_average2" name="acute_malnutrition_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                              </tr>
                                <tr>
                                  <td scope="row">4. Referral of severely and moderately acute malnourished children to Barangay Health Stations and/or Rural Health Units</td>
                                  <td>
                                  ...
                                  <td><textarea name="acute_malnutrition_remarks4" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" id="national_dietary_average2" name="national_dietary_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                              </tr>
                                <tr>
                                  <td scope="row">5. Nutritionally-at-risk pregnant women enrolled/ covered in the dietary supplementation program</td>
                                  <td>
                                  ...
                                  <td><textarea name="national_dietary_remarks5" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">6. Infants and young children 6-23 months old enrolled in the dietary supplementation program </td>
                                  <td>
                                  ...
                                  <td><textarea name="national_dietary_remarks6" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">7. Children in child development centers and supervised neighborhood play provided with dietary supplementation </td>
                                  <td>
                                  ...
                                  <td><textarea name="national_dietary_remarks7" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">8. Support to the School-based Feeding Program (SBFP) targeting children from Kinder to Grade VI who are wasted</td>
                                  <td>
                                  ...
                                  <td><textarea name="national_dietary_remarks8" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>

                                <tr>
                                  <th scope="row">{{__("National Nutrition Promotion Program for Behavior Change")}}</th>
                                  <th id="behavioral_change_average">0</th>
                                  <input type="hidden" id="behavioral_change_average2" name="behavioral_change_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                              </tr>
                                <tr>
                                  <td scope="row">9. Nutrition promotion activities for behavior change conducted for population groups</td>
                                  <td>
                                  ...
                                  <td><textarea name="behavioral_change_remarks9" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">10. Nutrition promotion for behavior change activities for the public conducted</td>
                                  <td>
                                  ...
                                  <td><textarea name="behavioral_change_remarks10" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" id="micro_supplement_average2" name="micro_supplement_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                               </tr>
                                <tr>
                                  ...
                                  <td><textarea name="micro_supplement_remark11" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  ...
                                  <td><textarea name="micro_supplement_remarks12" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">13. Vitamin A capsules provided to children 12-59 months old</td>
                                  <td>
                                  ...
                                  <td><textarea name="micro_supplement_remarks13" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">14. Micronutrient powder provided to young children 6-23 months old</td>
                                  <td>
                                  ...
                                  <td><textarea name="micro_supplement_remarks14" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">15. Weekly provision of iron-folic acid tablets to adolescent female learners in public schools through Weekly Iron Folic Acid (WIFA) Supplementation Program </td>
                                  <td>
                                  ...
                                  <td><textarea name="micro_supplement_remarks15" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">16. Weekly Iron Folic Acid (WIFA) provided to adolescent females in Grade 7 to 10 from private schools, out-of-school adolescent females and women aged 10-49 years not covered by WIFA in public schools  </td>
                                  <td>
                                  ...
                                  <td><textarea name="micro_supplement_remarks16" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" id="mandatory_food_average2" name="mandatory_food_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                               </tr>
                                <tr>
                                  ...
                                  <td><textarea name="mandatory_food_remarks17" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  ...
                                  <td><textarea name="mandatory_food_remarks18" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  ...
                                  <td><textarea name="mandatory_food_remarks19" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" id="emergencies_program_average2" name="emergencies_program_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                               </tr>
                                <tr>
                                  <td scope="row">20. NiEm Plan integration in the DRRM-H plan and Local DRRM Plan</td>
                                  <td>
                                  ...
                                  <td><textarea name="emergencies_program_remarks20" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>

                                <tr>
                                  <th scope="row">{{__("Overweight and Obesity Management and Prevention Program")}}</th>
                                  <th id="prevention_program_average">0</th>
                                  <input type="hidden" id="prevention_program_average2" name="prevention_program_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                               </tr>
                                <tr>
                                  <td scope="row">21. Activities promoting healthy diets and active lifestyle for preschool children conducted</td>
                                  <td>
                                  ...
                                  <td><textarea name="prevention_program_remarks21" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">22. Activities promoting proper diet and healthy lifestyle for the general public conducted</td>
                                  <td>
                                  ...
                                  <td><textarea name="prevention_program_remarks22" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" id="nutri_sensitive_average2" name="nutri_sensitive_average" value=""  class="form-control" />
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                               </tr>
                                <tr>
                                  <td scope="row">23. Eligible households with nutritionally vulnerable or affected provided with seed capital/ material assistance for livelihood</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks23" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">24. Eligible households with nutritionally vulnerable or affected provided with livelihood training</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks24" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">25. Gulayan sa Paaralan established and maintained in school</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks25" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">26. Households with nutritionally vulnerable or affected provided with inputs for backyard vegetable gardening</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks26" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks27" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">28. Ho
                               ...
                               useholds have access to sanitary toilet facilities</td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks28" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">29. Schools provided with access to safe water, adequate toilets, handwashing facilities through the WASH in Schools (WinS) program</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks29" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                                <tr>
                                  <td scope="row">30. Reproductive health programs for adolescents implemented</td>
                                  <td>
                                  ...
                                  <td><textarea name="nutri_sensitive_remarks30" class="form-control"></textarea></td>
                                  <td>  &nbsp; </td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <table class="table table-striped">
                              ...
                              <tr>
                                  ...
                                  <td><textarea name="underweight_child_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  ...
                                  <td><textarea name="stundent_child_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                  <td scope="row">{{__("Prevalence of overweight and obese children 0-59 months")}}</td>
                                  <td>
                              ...
                              <tr>
                                  <td scope="row">{{__("Prevalence of overweight and obese school children")}}</td>
                                  <td>
                              ...
                              <tr>
                                  <td scope="row">{{__("Prevalence of nutritionally at-risk pregnant women")}}</td>
                                  <td>
                        ...
                        <div class="form-section">
                            <table class="table table-striped">
                              ...
                              <tr>
                                  ...
                                  <td><textarea name="vision_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="vision_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="vision_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="vision_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  <td scope="row">{{__("2")}}</td>
                                  <td scope="row">{{__("Nutrition Laws and Policies")}}</td>
                                  <td><textarea name="policies_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="policies_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="policies_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="policies_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  <td scope="row">{{__("3")}}</td>
                                  <td scope="row">{{__("Governance and Organizational Structure")}}</td>
                                  <td><textarea name="governance_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="governance_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="governance_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="governance_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  <td scope="row">{{__("4")}}</td>
                                  <td scope="row">{{__("Local Nutrition Committee Management Functions")}}</td>
                                  <td><textarea name="nutri_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="nutri_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="nuti_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="nutri_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  <td scope="row">{{__("5")}}</td>
                                  <td scope="row">{{__("Nutrition Interventions/ Services")}}</td>
                                  <td><textarea name="services_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="services_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="services_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="services_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              <tr>
                                  <td scope="row">{{__("5")}}</td>
                                  <td scope="row">{{__("Changes in Nutritional Status in the Local Government Unit")}}</td>
                                  <td><textarea name="changes_good_practices_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="changes_issues_problems_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="changes_local_initiatives_remarks" class="form-control"></textarea></td>
                                  <td><textarea name="changes_immediate_actions_remarks" class="form-control"></textarea></td>
                              </tr>
                              </tbody>
                            </table>             
                        </div>
