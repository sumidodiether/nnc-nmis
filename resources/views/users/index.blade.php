                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="button-container text-center">
                        <button id="twitter" class="btn btn-round btn-info sharrre"><i class="fab fa-twitter"></i> ·
                            45</button>
                        <button id="facebook" class="btn btn-round btn-info sharrre"><i class="fab fa-facebook-f"></i> ·
                            50</button>
                        <br>
                        <br>
        ...
        <div class="sidebar" data-color="white">
            ...
            <div class="sidebar-wrapper" id="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li>
                        <a data-toggle="collapse" href="#lguPrfomance">
                        ...
                        <div class="collapse show" id="lguPrfomance">
                            <ul class="nav">
                                <li>
                    ...
                    <li>
                        <a data-toggle="collapse" href="#lguresources">
                            <!-- <i class="now-ui-icons ui-1_settings-gear-63"></i> -->
                            <p>
                                {{ __("Resources") }}
                                <b class="caret"></b>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-primary btn-round text-white pull-right" href="#"
                                    data-target="#addUser" data-toggle="modal">Add user</a>
                          ...
                          <i class="now-ui-icons ui-2_settings-90"></i>
                                                ...
                                                <a type="button" href="#" title="Edit" rel="tooltip"
                          ...
                          <i class="now-ui-icons files_box"></i>
                                                ...
                                                <a href="#" title="Delete"
                                                    class="btn btn-success btn-icon btn-sm btn-danger deleteButton"
                                                    data-id="{{ $users->id }}" data-toggle="modal"
                                                    data-target="#confirmDelete" rel="tooltip" id="deleteIcon">
                                                    <i class="now-ui-icons files_box"></i>
                                                </a>
                                            </td>
                                        </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <button type="submit" name="addUserBtn" data-mdb-button-init data-mdb-ripple-init
                            class="btn btn-primary btn-block">Add User</button>
                    </form>
                </div>
            </div>
        </div>
