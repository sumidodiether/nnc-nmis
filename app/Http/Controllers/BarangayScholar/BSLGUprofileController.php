 ...
 public function show(LguProfile $LguProfile, Request $request) { 
    ...
    public function update( Request $request , $id ) {
           ...
           $rules = [
            ...
            'noHousehold' => 'required|string|max:255',
            'noPuroks' => 'required|string|max:255',
            'populationA' => 'required|integer', 
            'populationB' => 'required|integer',  
            'populationC' => 'required|integer',  
            'populationD' => 'required|integer',  
            'populationE' => 'required|integer',
            'populationF' => 'required|integer',    
            'actualA' => 'required|integer',  
            'actualB' => 'required|integer',  
            'actualC' => 'required|integer',  
            'actualD' => 'required|integer',  
            'actualE' => 'required|integer', 
            'actualF' => 'required|integer',  
            'psnormalAAA' => 'required|string|max:255',
            'psunderweightAAA' => 'required|string|max:255',
            'pssevereUnderweightAAA' => 'required|string|max:255',
            'psoverweightAAA' => 'required|string|max:255',
